...
<head>
  ...
  <title>Best Sellers — HVAR.mall (Hong Kong)</title>
...
<body>
  ...
  <!-- Body of Best-Sellers -->

  <!-- Best-Sellers Title -->
  <div class="pages-title">
    <h2 class="pages-header">Best Sellers</h2>
    <p class="pages-hints">Our most popular products based on sales. Updated hourly.</p>
  </div>
  <!-- Best-Sellers Title -->

  <div class="best-sellers-side-menu-container container-fluid">
    <div class="row justify-content-around">
      <div class="best-sellers-side-menu col-2">

        <h1 class="best-sellers-side-menu-header">All Categories</h1>

        <div class="best-sellers-side-menu-categories">
