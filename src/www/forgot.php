...
<head>
  ...
  <!-- Forgot Body of CSS -->
  <link rel="stylesheet" href="../assets/css/forgot.css?v=1.1" />
    ...
    <div class="forgot-container">
      ...
      <form action="../assets/php/forgotfun.php" class="forgot-container-form" method="post">
        ...
        <div class="input-field">
          <input name="forgot-username" id="forgot-username" type="text" class="input-forgot-username" value="" />
          <label for="forgot-username" class="label-forgot-username">HVAR.mall ID</label>

        </div>
        <p class="forgot-id">If you have forgotten your HVAR.mall ID, you can <a href="../www/forgot-id.php">look it
            up</a>.</p>
        ...
        <input name="forgot-username-btn" id="forgot-continue-btn" type="submit" value="Continue" class="forgot-continue-btn active">

      </form>

      <form action="#" class="forgot-remind-form">
