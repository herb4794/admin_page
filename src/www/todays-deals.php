...
<head>
  ...
  <title>Today's Deals — HVAR.mall (Hong Kong)</title>
  ...
  <!-- Today's Deals of CSS -->
  <link rel="stylesheet" href="../assets/css/todays-deals.css" />
...
<body>
  ...
  <!-- Body of Today's Deals -->

  <!-- Today's Deals Title -->
  <div class="pages-title">

    <h2 class="pages-header">Today's Deals on Popular Products</h2>
  ...
  <div class="todays-deals-side-menu-container container-fluid">
    <div class="row justify-content-around">
      <div class="todays-deals-side-menu col-2">

        <h1 class="todays-deals-side-menu-header">All Categories</h1>

        <div class="todays-deals-side-menu-categories">
