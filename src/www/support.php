...
<head>
  ...
  <title>Support — HVAR.mall (Hong Kong)</title>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="support">
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100" src="../assets/images/support/banner/Support-banner.jpg" alt="Support Images">
          <div class="carousel-caption d-none d-md-block">
            <h5>HVAR.mall Support</h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid">
      ...
      <!-- Common Problem Part -->
      <div class="common-problem row">
        <a href="../www/forgot.php" class="forgot col">
          <i class="link-text"></i><br />
          <p>Forgot HVAR.mall ID or password</p>
        </a>

        <a href="#" class="goods-problem col">
          <i class="link-question"></i><br />
          <p>Goods Problem</p>
        </a>

        <a href="#" class="bill-and-subscriptions col">
          <i class="link-receipt"></i><br />
      ...
      <div class="search-bar-container row">
        <h2>Search for your problem</h2>
        <div class="search-bar">
          <div class="input-field">
            <i class="link-search"></i>
            <input id="sign-up-username" type="text" class="input-sign-up-username" />
          </div>
        </div>
      </div>
